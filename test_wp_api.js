...
// Ignore self-signed SSL certificate errors on local development environment
process.env.NODE_TLS_REJECT_UNAUTHORIZED = '0';

const pageData = {
    title: 'Antigravity Automation Test',
    content: `
        <div style="padding: 40px; background: #0f172a; color: #f8fafc; font-family: sans-serif; border-radius: 12px; max-width: 800px; margin: 40px auto; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
            <h1 style="color: #38bdf8; border-bottom: 2px solid #334155; padding-bottom: 10px;">🌌 Antigravity 2.0 Connection Success!</h1>
            <p style="font-size: 1.1rem; line-height: 1.6; color: #cbd5e1;">
                This page was automatically generated by the <b>Antigravity 2.0</b> AI agent using the native <b>WordPress REST API</b> and Application Passwords.
            </p>
